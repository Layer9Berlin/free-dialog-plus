...
export const DeleteAssessmentsModal = ({
  ...
  return (
    <Modal show={show} onHide={close}>
      ...
      <Modal.Body>
        {plural(count, {
          one: "Do you really want to delete the selected assessment? This cannot be undone.",
          other: "Do you really want to delete {selectionCount} assessments? This cannot be undone.",
        })}
      </Modal.Body>
      <Modal.Footer>
